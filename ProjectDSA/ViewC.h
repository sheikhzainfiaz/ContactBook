...
namespace ProjectDSA {
	...
	/// Summary for ViewC
	/// </summary>
	public ref class ViewC : public System::Windows::Forms::Form
	{
	public:
		int userid;
	...
	public:
		...
		ViewC(int user, ContactLinkedList^ LinkedList)
		{
			userid = user;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(ViewC::typeid));
			...
			this->dataGridView1->Location = System::Drawing::Point(274, 232);
			this->dataGridView1->Margin = System::Windows::Forms::Padding(8, 8, 8, 8);
			...
			this->dataGridView1->Size = System::Drawing::Size(464, 266);
			...
			this->pictureBox1->Location = System::Drawing::Point(358, 20);
			this->pictureBox1->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(291, 63);
			this->pictureBox1->TabIndex = 2;
			this->pictureBox1->TabStop = false;
			this->pictureBox1->Click += gcnew System::EventHandler(this, &ViewC::pictureBox1_Click);
			// 
			// ViewC
			// 
